        ...
        <main className="m-8 p-12">
            <article className="container shadow-lg mx-auto bg-green100 rounded-lg">
                <header className="relative">
                    ...
                    <img src={singlePost.mainImage.asset.url} alt={singlePost.title} className="w-full object-cover rounded-t" style={{ heigth: "400px" }}/>
                </header>
                <div className="px-16 lg:px-48 py-12 lg:py-20 prose lg:prose-xl max-w-full">
                    <BlockContent blocks={singlePost.body} projectId="lojjmclw" dataset="production" />
                     </div>
            </article>
        </main>
    )
